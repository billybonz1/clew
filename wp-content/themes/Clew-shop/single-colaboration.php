...
<section class="section__single-colab-card">

<div class="inner">
    <div class="colab-card-slider">
    ...
    <div class="single-colab__information">

        <div class="colab-information__header">

            <h3 class="colab-header__product-name"><?php the_title(); ?></h3>
            <span class="colab-header__product-type"><?php echo get_the_date(); ?></span>

        </div>

        <div class="colab-information-description">
        ...
        <div class="colab-single-follow">
            <div class="vk-share-button">
                <?php $title = get_the_title(); ?>
                <?php $description = get_field('excer'); ?>
                <?php $url = get_the_permalink(); ?>
                <?php $image_url = 'https://misha.blog/wp-content/themes/truemisha/a/apple-touch-icon-144x144-precomposed.png'
                    ?>
                    <a href="http://vkontakte.ru/share.php?url=<?php echo urlencode($url); ?>&title=<?php echo $title; ?>&description=<?php echo $description; ?>&image=<?php echo $image_url; ?>&noparse=true" onclick="window.open(this.href, this.title, 'toolbar=0, status=0, width=548, height=325'); return false" title="Сохранить в Вконтакте" target="_parent"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/vk-icon.png" alt=""> Поділитися</a>
            </div>
            <div class="fb-share-button" data-href="<?php the_permalink(); ?>" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Поділитися</a></div>
            
            <div class="tg-share-button"><a class="tgme_action_button" href="tg://msg_url?url=<?php the_permalink(); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tg-icon.png" alt=""></a></div>
            <div class="tw-share-button">
            <?php
                $text = get_field('excer'); // текст твита
                $url = get_permalink(); // ссылка на страницу
                ?>
                <a href="http://twitter.com/share?text=<?php echo $text ?>&url=<?php echo urlencode( $url ) ?>" title="Поделиться ссылкой в Твиттере" onclick="window.open(this.href, this.title, 'toolbar=0, status=0, width=548, height=325'); return false" target="_parent"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/tw-icon.png" alt=""></a>
...
<section class="c-single__more-product c-single__more-colab">

<div class="inner">
    <div class="section__title">
        <h2>Результат колоборації:</h2>
    </div>
    ...
    <div class="section__view-all">
        <a class="hover-theme" href="#">Усі Стандартні шкарпетки</a>
    </div>
</div>
